...
gulp.task('browsersync', function () {
  ...
  gulp.watch(['source/scss/above.scss', 'source/scss/components/above/**/*', 'source/scss/components/elements/**/*'], ['styles:above'])
  gulp.watch(['source/scss/below.scss', 'source/scss/components/below/**/*'], ['styles:below'])
